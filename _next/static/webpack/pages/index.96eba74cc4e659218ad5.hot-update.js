...
})(["margin-left:-12px;max-width:1040px;display:flex;@media ", "{display:flex;}@media ", "{display:flex;width:100%;flex-direction:column;}"], function (props) {
  return props.theme.breakpoints.md;
}, function (props) {
  return props.theme.breakpoints.sm;
});
